...
from G31_KID_design.Patterns import circularTriangleLattice as ctl
import numpy as np

WAFER_DIAMETER = 50000.0 # microns
n, x, y, r = ctl(radius=0.5*WAFER_DIAMETER, pitch=1830.0, element_dimension=1000.0, rotation=-1)
