...
for (i,idx) in enumerate(data['index']):
    ...
    pixel.save_dxf('./pixels/pixel_{:d}.dxf'.format(idx))

# draw array and save figure
array = Array("./pixels", 9, data['x'], data['y'], data['rot'], data['mir'])
array.saveFig("./array.png", dpi=350)
